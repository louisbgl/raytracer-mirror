...
private:
    ...
    // Bounded shapes (AShape - support rotation and scale)
    ...
    static std::shared_ptr<IShape> _createMesh             (const libconfig::Setting& config, std::shared_ptr<IMaterial> material);
};
